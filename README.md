...
1. Compile project and run bootJar task to generate a jar file. Alternatively the included jar file in the [releases](releases) section should work for most users with no changes. It can also be deployed to Tomcat via the war file. 
